...
const copy = {
  ru: {
    ...
    heroTitle: 'CareerTree — карьерные переходы в IT', heroLead: 'Выбери текущую роль, оцени навыки и посмотри детальный путь до DevOps Engineer.',
  ...
  en: {
    ...
    heroTitle: 'CareerTree — IT Career Paths', heroLead: 'Choose your current role, assess your skills, and see the detailed path to DevOps Engineer.',
